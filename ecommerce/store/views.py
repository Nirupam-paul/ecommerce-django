        ...
        try:
            ...
            try:
                ...
                for order_item in cart_items:
                    ...
                    # print a message when the order is placed
...
def sendEmail(order_id):
    ...
    try:
        subject = "Technohub - New Order #{}".format(transaction.id)
        to = ['{}'.format(transaction.email)]
        from_email = 'orders@sandboxf34a036acd9b4b69b3db14c769ea3928.mailgun.org'
        order_information = {
...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            msg = EmailMessage(subject, message_format, to=[
                               'nirupam17paul@gmail.com'], from_email=from_email)
            msg.send()
